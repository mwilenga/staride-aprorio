            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title"><i class="fa-user" aria-hidden="true"></i>
                        @lang("$string_file.arrived") @lang("$string_file.orders")
                    </h3>
                </header>
                    ...
                    <table id="customDataTable" class="display nowrap table table-hover table-stripedw-full" style="width:100%">
                        ...
                        @foreach($arr_orders as $order)
                            ...
                            <tr>
                                ...
                                @if(!empty($order->otp_for_pickup)) <span class="badge badge-info">OTP: {{$order->otp_for_pickup}}</span> @endif
                                ...
                                <td>
                                    <a title=""
                                       href="{{route('laundry-outlet.process-order',$order->id)}}"
