...
<head>
    ...
    <title>Laundry Outlet Login Template</title>
...
<![endif]-->
@php
    if(!empty($laundry_outlet->login_background_image))
        $url=get_image($laundry_outlet->login_background_image,'laundry_outlet_login_background_image',$merchant->id,true);
    else
...
<div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content">
        ...
        {{--            <div class="brand">--}}
        {{--                <img class="brand-img" src="{{ get_image($laundry_outlet->business_logo,'business_logo',$merchant->id,true) }}" alt="...">--}}
        {{--                <h2 class="brand-text font-size-40">{{ $laundry_outlet->full_name }}</h2>--}}
        {{--            </div>--}}
        {{--        </div>--}}

        <div class="page-login-main animation-slide-right animation-duration-1">
            <div class="brand mb-0">
                <img class="brand-img" src="{{ get_image($laundry_outlet->business_logo,'laundry_outlet_logo',$laundry_outlet->merchant_id,true) }}" alt="..." width="80px">
                {{--                <h3 class="brand-text font-size-40">{{ $laundry_outlet->full_name }}</h3>--}}
            </div>
            <h3 class="font-size-24">{{ $laundry_outlet->full_name }}</h3>
            <form method="post" action="{{ route('laundry_outlet.login.submit',$laundry_outlet->alias_name) }}">
                @csrf
