            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <section id="validation">
                        {!! Form::open(["id" => "handyman-pricecard-form", "name" => "handyman-pricecard-form", "class"=>"steps-validation wizard-notification","files"=>true,"url"=>route("handyman-store.price_card.save",$id)]) !!}
                        {!! Form::hidden('id',$id) !!}
                        <fieldset>
                                <div class="row">
                                    {{-- <div class="col-md-4">
        ...
        function getService() {
            ...
            if ( price_type == 1) {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: '<?php echo route('handyman-store.price_card.services') ?>',
                    data: {segment_id:segment_id,segment_group:2,segment_price_card_id:segment_price_card_id},
                    success: function (data) {
