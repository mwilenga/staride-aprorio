...
<![endif]-->
@php
    if(!empty($handyman_store->login_background_image))
        $url=get_image($handyman_store->login_background_image,'handyman_store_login_background_image',$merchant->id,true);
    else
...
<div class="page" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content">
        ...
        {{--            <div class="brand">--}}
        {{--                <img class="brand-img" src="{{ get_image($handyman_store->business_logo,'business_logo',$merchant->id,true) }}" alt="...">--}}
        {{--                <h2 class="brand-text font-size-40">{{ $handyman_store->full_name }}</h2>--}}
        {{--            </div>--}}
        {{--        </div>--}}

        <div class="page-login-main animation-slide-right animation-duration-1">
            <div class="brand mb-0">
                <img class="brand-img" src="{{ get_image($handyman_store->business_logo,'handyman_store_logo',$handyman_store->merchant_id,true) }}" alt="..." width="80px">
                {{--                <h3 class="brand-text font-size-40">{{ $handyman_store->full_name }}</h3>--}}
            </div>
            <h3 class="font-size-24">{{ $handyman_store->full_name }}</h3>
            <form method="post" action="{{ route('handyman_store.login.submit',$handyman_store->alias_name) }}">
                @csrf
