            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    <div class="panel-actions">
                        ...
                        @endif
                        <a href="{{route("handyman-store.segment.handyman-category.add")}}">
                ...
                <div class="panel-body container-fluid">
                    <table id="customDataTable" class="display nowrap table table-hover table-stripedw-full"
                        ...
                        @foreach($handyman_categories as $handyman_category)
                            <tr>
                                ...
                                <td>
                                    <img src="{{ get_image($handyman_category->icon,'category',$handyman_category->HandymanStore->merchant_id)}}" width="80px" height="80px">
                                </td>
                                <td>
                                ...
                                <td style="width:100px;float:left">
                                    <a href="{{ route('handyman-store.segment.handyman-category.add',$handyman_category->id) }}"
                    ...
                    {{-- @include('handyman-store.shared.table-footer', ['table_data' => $handyman_categories, 'data' => []]) --}}
                </div>
            </div>
        </div>
    </div>
