            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <section id="validation">
                        {!! Form::open(["class"=>"steps-validation wizard-notification","id" => "handyman-category-form","files"=>true,"url"=>route("handyman-store.segment.handyman-category.save",$id)]) !!}
                        {!! Form::hidden('id',$id) !!}
                        <fieldset>
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        @if($id != NULL)
                                            <div class="form-group">
                                                {{$data['handyman_category']->Segment->Name($data['handyman_category']['handyman_store_id'])}}
    ...
    <script>
        function getService() {
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "{{route('handyman-store.segment.services')}}",
                data: {
