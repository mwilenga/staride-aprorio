                        ...
                        <div class="col-xl-3 col-md-3 info-panel">
                            <div class="card card-shadow">
                                <div class="card-block bg-grey-100 p-20">
                                    ...
                                    <span class="ml-15 font-weight-400">@lang("$string_file.handyman_store_earning")</span>
                                    <div class="content-text text-center mb-0">
                                        <span class="font-size-20 font-weight-100">{{isset($earning_summary['store_earning']) ? $currency.$earning_summary['store_earning'] : 0}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                ...
                                <div class="card-block bg-white table-responsive">
                                    <table id="customDataTable"
                                        ...
                                        <tr class="text-center report_table_row_heading">
                                            ...
                                            <th colspan="4">@lang("$string_file.handyman_store_earning")</th>
                                        ...
                                        @if(!empty($arr_bookings))
                                            ...
                                            @foreach($arr_bookings as $booking)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if(!empty($transaction))
                                                            {{$transaction->handyman_store_earning }}
                                                        @endif
                                                    </td>
                                                    <td>
                                                        {{ !empty($booking->tip) ? $booking->tip : 0}}
                                                    ...
                                                    <td>
                                                            ...
                                                            <b> {{ $currency.' '.($transaction->handyman_store_earning + $tax_amount + $booking->tip) }} </b>
                                                    </td>
                                                    <td>
