        ...
        <div class="page-content">
            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" enctype="multipart/form-data" action="{{ route('handyman-store.services.store') }}">
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            @if(Auth::user('handyman-store')->Merchant->ApplicationConfiguration->dynamic_url_configuration == 1)
                                <div class="col-md-4">
                                    <div class="form-group">
