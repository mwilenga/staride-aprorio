        ...
        <div class="page-content">
            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" enctype="multipart/form-data" action="{{ route('handyman-store.services.update',isset($service->id) ? $service->id : NULL) }}">
                        {{method_field('PUT')}}
                        @csrf
                        <div class="row">
                            <div class="col-md-4">
                                    ...
                                    <div class="form-group">
                                        <label for="icon">
                                            ...
                                            @if(isset($service['pivot']->service_icon) && $service['pivot']->service_icon != '')
                                                <a href="{{get_image($service['pivot']->service_icon,'service', $merchant->id)}}" target="_blank">@lang("$string_file.view")</a>
