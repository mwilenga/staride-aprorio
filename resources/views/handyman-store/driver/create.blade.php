            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    ...
                    @if($id == NULL || $edit_permission)
                        {!! Form::open(["class"=>"steps-validation wizard-notification", "files"=>true,"url"=>route('handyman-store.driver.save',$id), "id" => "driver-register", "name" => "driver-register"]) !!}
...
@section('js')
    <script>
        getCountryConfig({{$store->country_id}}, "{{$id}}");
        getPersonalDocs({{$store->country_area_id}});

        function getCountryConfig(id, driver_id){
            $.ajax({
                method: 'GET',
                url: "{{ route('handyman-store.country.config') }}",
        ...
        function getPersonalDocs(area_id){
            if (area_id != "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "{{ route('handyman-store.driver.country-area-document') }}",
