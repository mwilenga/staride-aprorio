        ...
        <div class="page-content">
            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    {!! Form::open(['name'=>'','class'=>'steps-validation wizard-notification','id'=>'driver-handyman-segment','files'=>true,'url'=>route('handyman-store.driver.handyman.segment.save',$id)]) !!}
