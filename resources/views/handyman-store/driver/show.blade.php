            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    <div class="panel-actions">
                        <a href="{{ route('handyman-store.driver.index') }}" data-toggle="tooltip">
                        ...
                        <div class="col-md-12">
                                                    ...
                                                    <div class="">
                                                        <div class="row no-gutters align-items-center">
                                                            <div class="col mr-2">
                                                                ...
                                                                <div class="h6 mb-0 font-weight-400"
                                                                     style="color:#7c8c9a">{{$driver->vat_number}}</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            @php
                                                               ...
                                                               $p_doc = get_image($document->document_file,'driver_document', $driver->merchant_id);
                                                            @endphp
                                                                @if($is_pdf)
                                                                    ...
                                                                    @foreach($segment->DriverSegmentDocument as $document)
                                                                        <tr>
                                                                            ...
                                                                            <td class="text-center">
                                                                                @php
                                                                                    $is_pdf = check_file_extension($document->document_file);
                                                                                    $p_doc = get_image($document->document_file,'segment_document', $driver->merchant_id);
                                                                                @endphp
                                                                                @if($is_pdf)
                                                                                    <embed src="{{ $p_doc }}" width="100px" height="100px" />
                                                                                    <br>
                                                            ...
                                                            <div class="" style="width: 6.5rem;">
                                                                <div class=" bg-light">
                                                                    ...
                                                                    @php
                                                                        ...
                                                                        $vehicle_image = get_image($vehicle_details->vehicle_image,'vehicle_document', $driver->merchant_id);
                                                                    @endphp
                                                                    @if($is_pdf)
                            ...
                            @if($driver->signupStep <= 8 && $driver->reject_driver !=2)
                                <div class="float-right mt-10">
                                    @if($driver->signupStep == 8)
                                        <a href="{{ route('handyman-store.driver-vehicle-verify',[$driver->id,1]) }}">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td class="text-center">
                                                                        ...
                                                                        @php
                                                                            ...
                                                                            $file = get_image($document->temp_document_file,'driver_document', $driver->merchant_id);
                                                                        @endphp
                                                                        @if($is_pdf)
...
{{--                                    <div class="float-right mt-10">--}}
{{--                                        <a href="{{ route('handyman-store.driverTempDocVerify',[$driver->id,1]) }}">--}}
{{--                                            <button class="btn btn-success float-right">@lang("$string_file.approve")</button>--}}
{{--                                        </a>--}}
    ...
    <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                <form class="form-group" action="{{ route('handyman-store.driver-vehicle-reject') }}" method="post">
                    @csrf
