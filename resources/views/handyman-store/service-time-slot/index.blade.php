            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    <div class="panel-actions">
                        ...
                        @endif
                        <a href="{{route('handyman-store.segment.service-time-slot.add')}}">
...
{{--                                </td>--}}
                                ...
                                <td>
                                    <a href="{{ route('handyman-store.segment.service-time-slot.edit',$service_time_slot->id) }}"
                                       data-original-title="@lang("$string_file.edit")"
                                       class="btn btn-sm btn-warning menu-icon btn_edit action_btn"> <i
                                                class="fa fa-edit"></i> </a>

                                    <a href="{{ route('handyman-store.service-time-slot.detail',$service_time_slot->id) }}"
