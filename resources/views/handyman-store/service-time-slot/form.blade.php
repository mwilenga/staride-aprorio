        ...
        <div class="panel panel-bordered">
            ...
            <div class="panel-body container-fluid">
                <section id="validation">
                    {!! Form::open(["id" => "service-time-slot-form","name" => "service-time-slot-form","class"=>"steps-validation wizard-notification","files"=>true,"url"=>route("handyman-store.segment.service-time-slot.save")]) !!}
...
@include('handyman-store.shared.info-setting',['info_setting'=>$info_setting,'page_name'=>'add_text'])
@endsection
@section('js')
...
{{--    },--}}
    method: 'GET',
    url: '<?php echo route('handyman-store.segment.options', ['option'=>2]) ?>',
{{--    data: {area_id: area_id,segment_group_id:[2,4], sub_group_for_app: 2, check_where_or:true},--}}
