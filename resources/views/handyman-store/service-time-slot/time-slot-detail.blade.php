...
@section('content')
            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <section id="validation">
                        {!! Form::open(["class"=>"steps-validation wizard-notification","id"=>"time-slot-details","url"=>route("handyman-store.service-time-slot.detail.save")]) !!}
    ...
    @include('handyman-store.shared.info-setting',['info_setting'=>$info_setting,'page_name'=>'edit_text'])
@endsection
@section('js')
    <script>
        $('input').blur();
