            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification"
                          ...
                          action="{{ route('handyman-store.advertisement.store') }}@if(!empty($banner)){{ '/'.$banner->id }} @endif">
                        @csrf
                        <fieldset>
                                    ...
                                    <div class="form-group">
                                        <label for="">
                                            ...
                                            @if(isset($banner->image) && $banner->image != '')
                                                <a href="{{ get_image($banner->image,'handyman_store_banners',$banner->HandymanStore->merchant_id) }}"
...
{{--                                </div>--}}
                                ...
                                {{-- <div class="col-md-4"
                                    ...
                                    <div class="form-group">
                                        ...
                                        {{ Form::select('handyman_store_id', $arr_handyman_store,old('handyman_store_id', isset($banner->handyman_store_id ) ? $banner->handyman_store_id  : ''), ['class' => 'form-control', 'id' => 'handyman_store_id'])}}
                                        @if ($errors->has('handyman_store_id'))
                                            <label class="text-danger">{{ $errors->first('handyman_store_id') }}</label>
                                        @endif
                                    </div>
                                </div> --}}
