        ...
        <div class="page-content">
            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    {!! Form::open(['name'=>"",'url'=>route('agent.driver.allvehicles'),'method'=>"GET"]) !!}
                        ...
                        @foreach($driver_vehicles as $value)
                            @foreach($value->DriverVehicles as $vehicle)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a href="{{ route('agent.driver-vehicledetails',$vehicle->id) }}"
                                        ...
                                        <a href="{{ route('agent.driver.vehicle.create',[$vehicle->driver_id,$vehicle->id]) }}"
...
@section('js')
    <script>
        ...
        {{--                        type: "success",--}}
        {{--                    });--}}
        {{--                    window.location.href = "{{ route('agent.driver.allvehicles') }}";--}}
        {{--                });--}}
        {{--            } else {--}}
