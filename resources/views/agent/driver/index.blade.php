...
{{--                            <th>@lang("$string_file.transaction_amount")</th>--}}
                        ...
                        @foreach($drivers as $driver)
                            <tr>
                                <td><a href="{{ route('agent.driver.show',$driver->id) }}"
                                ...
                                <td>
                                    <div class="button-margin" >
                                        <a href="{{ route('agent.driver.add',$driver->id) }}"
    ...
    <div class="modal fade text-left" id="sendNotificationModel" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('agent.sendsingle-driver') }}" method="post" enctype="multipart/form-data">
                    @csrf
            ...
            swal({
                ...
                if (isConfirm) {
                    $.ajax({
                        ...
                        url: "{{route('agent.drivers.delete')}}",
                    }).done(function (data) {
                        swal({
                            title: "DELETED!",
                            text: data,
                        ...
                        window.location.href = "{{ route('agent.driver.index') }}";
                    });
                } else {
