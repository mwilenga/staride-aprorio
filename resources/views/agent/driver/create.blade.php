...
@section('content')
    <div class="page">
        <div class="page-content">
            @include('agent.shared.errors-and-messages')
            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    <div class="panel-actions">
                        <a href="{{ route('agent.driver.index') }}" data-toggle="tooltip">
                ...
                <div class="panel-body container-fluid">
                    ...
                    @endif
                    @if(Auth::user()->demo != 1)
                        {!! Form::open(["class"=>"steps-validation wizard-notification", "files"=>true,"url"=>route('agent.driver.save',$id),"onsubmit"=>"return validatesignup()"]) !!}
...
<script>
    $(document).on('change', '#country', function () {
        ...
        $.ajax({
            method: 'GET',
            url: "{{ route('agent.country.config') }}",
            data: {id: id},
    ...
    function getAreaList(obj) {
        ...
        $.ajax({
            method: 'GET',
            url: "{{ route('agent.country.arealist') }}",
            data: {country_id: id},
            success: function (data) {
                $('#area').html(data);
            }
    ...
    $(document).on('change', '#area', function (e) {
        ...
        if (area_id != "") {
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "{{ route('agent.driver.country-area-document') }}",
