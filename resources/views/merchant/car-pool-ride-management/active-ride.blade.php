            ...
            <div class="panel panel-bordered">
                ...
                <table id="customDataTable" class="display nowrap table table-hover table-striped w-full"
                    ...
                    <tr>
                        ...
                        <td>
                            <span class="long_text">
                                {!! is_demo_data($active->CarpoolingRide->User->UserName, $active->CarpoolingRide->Merchant) !!}<br>
                                {!! is_demo_data($active->CarpoolingRide->User->UserPhone, $active->CarpoolingRide->Merchant) !!}<br>
                                {!! is_demo_data($active->CarpoolingRide->User->email, $active->CarpoolingRide->Merchant) !!}
                            </span>
                        </td>
