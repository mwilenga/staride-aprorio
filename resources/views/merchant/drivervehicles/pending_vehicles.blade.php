                    ...
                    <table id="customDataTable" class="display nowrap table table-hover table-stripedw-full" style="width:100%">
                        ...
                        <tr>
                            ...
                            @if($driver_add_vehicle_seatOrside_image_enable == 1)
                                 <th>@lang("$string_file.seat_image")</th>
                                <th>@lang("$string_file.side_view_image")</th>
                            @endif
                        ...
                        @foreach($driver_vehicles as $value)
                            @foreach($value->DriverVehicles as $vehicle)
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <a target="_blank"
                                           href="{{ get_image($vehicle->vehicle_seat_image,'vehicle_document') }}">
                                            <img src="{{ get_image($vehicle->vehicle_seat_image,'vehicle_document') }}"
                                                 alt="avatar"
                                                 style="width: 80px;height: 80px;border-radius:10px;">
                                        </a>
                                    </td>
                                    <td class="text-center">
                                        <a target="_blank"
                                           href="{{ get_image($vehicle->vehicle_side_view_image,'vehicle_document') }}">
                                            <img src="{{ get_image($vehicle->vehicle_side_view_image,'vehicle_document') }}"
                                                 alt="avatar"
                                                 style="width: 80px;height: 80px;border-radius:10px;">
                                        </a>
                                    </td>
