        ...
        <div class="page-content">
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <div class="card-body">
{{--                        <h5> @lang("$string_file.vehicle_type") : {{ $vehicle->VehicleType->VehicleTypeName }}</h5>--}}
{{--                        <hr>--}}
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                @lang("$string_file.registered_date")   : {!! convertTimeToUSERzone($vehicle->vehicle_register_date, $vehicle->Driver->CountryArea->timezone,null,$vehicle->Driver->Merchant, 2) !!}
                            </div>
                            <div class="col-md-4">
                                @lang("$string_file.expire_date")   : {!! convertTimeToUSERzone($vehicle->vehicle_expire_date, $vehicle->Driver->CountryArea->timezone,null,$vehicle->Driver->Merchant, 2) !!}
                            </div>
                            @endif
...
{{--                        <hr>--}}
                        <div class="row">
                            <div class="col-md-5">
                               ...
                               @php $vehicle_image = get_image($vehicle->vehicle_image,'vehicle_document'); @endphp
                            ...
                            <div class="col-md-7">
                                ...
                                @php $number_plate = get_image($vehicle->vehicle_number_plate_image,'vehicle_document'); @endphp
                                <div class="" style="width: 6.5rem;">
                                    <div class=" bg-light">
                    ...
                    @if($driver_add_vehicle_seatOrside_image_enable == 1)
                        <div class="row">
                            <div class="col-md-5">
                                <h5>@lang("$string_file.seat_image") </h5>
                               @php $vehicle_seat_image = get_image($vehicle->vehicle_seat_image,'vehicle_document'); @endphp
                                <div class="" style="width: 6.5rem;">
                                    <div class=" bg-light">
                                        <a href="{{ $vehicle_seat_image }}" target="_blank">
                                            <img src="{{ $vehicle_seat_image }}" class="rounded" alt="@lang("$string_file.seat_image") " width="100" height="100">
                                        </a>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-7">
                                <h5>@lang("$string_file.side_view_image") </h5>
                                @php $vehicle_side_view_image = get_image($vehicle->vehicle_side_view_image,'vehicle_document'); @endphp
                                <div class="" style="width: 6.5rem;">
                                    <div class=" bg-light">
                                        <a href="{{ $vehicle_side_view_image }}" target="_blank">
                                            <img src="{{ $vehicle_side_view_image }}" class="rounded" alt="@lang("$string_file.vehicle_side_view_image") " width="100" height="100">
                                        </a>
                                    </div>
                                </div>
                            </div>
