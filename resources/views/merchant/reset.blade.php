...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Reset Password | {{ $merchant->BusinessName }}</title>
...
<div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">>
  <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
    ...
    <form method="POST" action="{{ route('password.update',$merchant->alias_name) }}" style="margin:0px 0px;">
      @csrf
      <input type="hidden" name="token" value="{{ $token }}">
        <div class="form-group">
            <label class="sr-only" for="inputEmail">Email</label>
            {{ Form::text('email', old('email',$email), ["class" => "form-control", "id" => 'email', "placeholder" => "Enter Email", "autocomplete" => "off", "required", "autofocus",'readonly'=>true]) }}
            @error('email')
        ...
        <div class="form-group">
            ...
            {{ Form::password('password_confirmation', ["class" => "form-control", "id" => "confirm_password", "placeholder" => "Enter confirm Password", "autocomplete" => "off", "required", "autofocus"]) }}
