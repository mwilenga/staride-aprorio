...
<head><meta http-equiv="Content-Type" content="text/html; charset=utf-8">
  ...
  <title>Forgot Password | {{ $merchant->BusinessName }}</title>
...
<div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">>
  <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
    ...
    <form method="POST" action="{{ route('password.email',$merchant->alias_name) }}" style="margin:0px 0px;">
      @csrf
      ...
      {{ Form::submit('Forgot Password', ["class" => "btn btn-primary btn-block"]) }}
    </form>
    <a href="{{route('merchant.login',$merchant->alias_name)}}" class="btn btn-secondary mt-2 form-control">Sign In</a>
    <br>
