                    ...
                    <form method="POST" class="steps-validation wizard-notification" enctype="multipart/form-data" id="manualDispatchForm"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <hr>
                                <div class="row">
                                    <div class="col-md-6" id="corporate_div">
                                        <div class="form-group">
                                            <select class="form-control select2" name="corporate_id"
                                                    id="corporate_id" onchange="getCorporateUsers(this.value)">
                                                <option value=""> @lang("$string_file.select") @lang("$string_file.corporate") </option>
                                    ...
                                    <div class="col-md-6" id="corporate_div">
                                        <div class="form-group">
                                            <select class="form-control select2" name="user_id"
                                                    id="user_id" >
                                                <option value=""> @lang("$string_file.select") @lang("$string_file.corporate") @lang("$string_file.user")</option>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control" name="price_for_ride" id="price_for_ride">
                                                ...
                                                {{--                                                <option value="4">@lang("$string_file.corporate_charge")</option>--}}
                                            </select>
                                        </div>
                                    </div>
                                ...
                                <h5><i class="fa fa-dollar"></i> @lang("$string_file.manual_corporate_fee")</h5>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select class="form-control" name="is_manual_corporate_fee" id="is_manual_corporate_fee">
                                                <option selected value="1">@lang("$string_file.no")</option>
                                                <option value="2">@lang("$string_file.yes")</option>
                                            </select>
                                        </div>
                                    </div>
                                    <div class="col-md-6 custom-hidden" id="manual_corporate_fee_div">
                                        <div class="form-group">
                                            <input class="form-control" type="number" id="manual_corporate_fee" name="manual_corporate_fee" placeholder="@lang("$string_file.enter_amount")" onkeyup="checkZero(this)">
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div id="manual_driver_selection">
                            <div class="row">
                                ...
                                <div class="col-md-4 form-group">
                                    ...
                                    <input type="number" class="form-control" id="ride_radius_driver" name="ride_radius" required="" value="{{$driver_ride_radius}}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="number" class="c-select form-control"
                                               ...
                                               name="ride_radius_manual_driver" value="{{$driver_ride_radius}}" min="0" disabled>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
...
@section('js')
    ...
    <script>
        ...
        $('#check_user_details').click(function () {
            ...
            var manual_user_type = $('#manual_user_type').val();
            ...
            if (user_phone == "") {
                ...
                $.ajax({
                    ...
                    method: 'POST',
                    url: "SearchUser",
                    data: {user_phone: number,country_id:country_id, manual_user_type: manual_user_type, corporate_id: corporate_id},
        ...
        function getCorporateUsers(corporate_id){
            var token = $('[name="_token"]').val();
                $.ajax({
                    headers: {
                        'X-CSRF-TOKEN': token
                    ...
                    success: function (response) {
                        var users = response.users;
                         var $select = $('#user_id');
                                ...
                                // add default option
                                $select.append('<option value="">Select Corporate User</option>');
                                ...
                                $.each(users, function(index, user) {
                                    $select.append(
                                        $('<option>', {
                                            value: user.id,
                                            text: user.first_name+" "+user.last_name+" ( "+user.UserPhone+" ) ",
                                        })
                                    );
                                });
                            ...
                            $('#pickup_location').prop('disabled', false);
                            $('#drop_location').prop('disabled', false);
                            $("#distance_unit").val(response.distance_unit);
                    }, error: function (err) {
        {{--                        $('#user_id').val('');--}}
        {{--                        swal("This Phone Number Is Not Registered !");--}}
        $("#full_details").removeAttr("href");
        ...
        $('#pickup_location').prop('disabled', true);
            $('#drop_location').prop('disabled', true);
    }
});
}
...
//         }
        ...
        $('#is_manual_corporate_fee').on("change", function() {
            if($(this).val() == 2)
            {
                $('#manual_corporate_fee_div').show();
            }
            else
            {
                $('#manual_corporate_fee_div').hide();
            }
        });
