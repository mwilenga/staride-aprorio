            ...
            <div class="mr--10 ml--10">
                ...
                @if(Auth::user('merchant')->can('dashboard'))
                    <!-- Site Statistics -->
                                ...
                                <div class="panel panel-bordered">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                                ...
                                                <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                                    <a href="{{ route('merchant.driver.goingtoexpiredocuments') }}">
                                                        <div class="card card-shadow"
                                                            ...
                                                            <div class="card-block bg-white p-20 text-center">
                                                                <button type="button"
                                                                        class="btn btn-floating btn-sm btn-danger"
                                                                        style="box-shadow:0 4px 1px rgba(0,0,0,.63)">
                                                                    <i class="icon wb-file"></i>
                                                                </button>
                                                                <span class="ml-10 font-weight-400" style="text-align:center !important">@lang("$string_file.docs_going_expire")</span>
                                                                <div class="content-text text-center mb-0">
                                            ...
                                            @endif
                                            @if($merchant->BookingConfiguration->handyman_booking_dispute == 1)
                                                <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                                    <a href="{{ route('handyman.orders') }}">
                                                        <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                            <div class="card-block bg-white p-20">
                                                                <button type="button"
                                                                        class="btn btn-floating btn-sm btn-success"
                                                                ...
                                                                <span class="ml-10 font-weight-400">@lang("$string_file.dispute")</span>
                                                                <div class="content-text text-center mb-0">
                                                                    <span class="font-size-18 font-weight-100">{{ $site_states->handyman_dispute_orders }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
                                            ...
                                            @endif
                                            @if(in_array(2,$merchant_segment_group_config) && $merchant->Configuration->service_provider_low_balence == 1)
                                                <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                                    <a href="{{route('service-provider.low-balence')}}">
                                                        <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                            <div class="card-block bg-white p-20">
                                                                <button type="button"
                                                                        class="btn btn-floating btn-sm btn-success"
                                                                ...
                                                                <span class="ml-10 font-weight-400">@lang("$string_file.service_provider_low_balence")</span>
                                                                <div class="content-text text-center mb-0">
                                                                    <span class="font-size-18 font-weight-100">{{ $site_states->handyman_service_providers_wallet_low }}</span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </a>
                        ...
                        @endif
                        @if(in_array(3,$merchant_segment_group_config) && Auth::user('merchant')->can('CARPOOLING') && Auth::user('merchant')->can('ride_management_CARPOOLING') && Auth::user('merchant')->can('offer_ride_management_CARPOOLING') && Auth::user('merchant')->can('price_card_CARPOOLING') && $carpooling_states->carpooling_is_coming_soon == 2)
                        ...
                        @endif
                        @if(in_array(4,$merchant_segment_group_config) && $bus_booking_states->bus_booking_is_coming_soon == 2)
                        <!------ Bus Booking Statistics --------->
                            <div class="col-12 col-md-12 col-sm-12">
                                <!-- Example Panel With Heading -->
                                <div class="panel panel-bordered">
                                    <div class="panel-heading">
                                        <div class="panel-actions"></div>
                                        <h3 class="panel-title">@lang("$string_file.bus_booking") @lang("common.statics")</h3>
                                    </div>
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-xl-3 col-md-3 col-sm-6 info-panel">
                                                <a href="#">
                                                    <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                        <div class="card-block bg-white p-20">
                                                            ...
                                                            <span class="ml-10 font-weight-400">@lang("$string_file.active") @lang("$string_file.bus_booking")</span>
                                                            <div class="content-text text-center mb-0">
                                                                <span class="font-size-18 font-weight-100">{{ $bus_booking_states->active_bus_bookings }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a href="#">
                                                    <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                        <div class="card-block bg-white p-20">
                                                            ...
                                                            <span class="ml-10 font-weight-400">@lang("$string_file.total") @lang("$string_file.bus_booking")</span>
                                                            <div class="content-text text-center mb-0">
                                                                <span class="font-size-18 font-weight-100">{{ $bus_booking_states->bus_bookings }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a href="#">
                                                    <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                        <div class="card-block bg-white p-20">
                                                            ...
                                                            <span class="ml-10 font-weight-400">@lang("$string_file.active") @lang("$string_file.bus_booking_master")</span>
                                                            <div class="content-text text-center mb-0">
                                                                <span class="font-size-18 font-weight-100">{{ $bus_booking_states->active_master_bus_bookings }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <a href="#">
                                                    <div class="card card-shadow" style="margin-bottom:0.243rem">
                                                        <div class="card-block bg-white p-20">
                                                            ...
                                                            <span class="ml-10 font-weight-400">@lang("$string_file.total") @lang("$string_file.bus_booking_master")</span>
                                                            <div class="content-text text-center mb-0">
                                                                <span class="font-size-18 font-weight-100">{{ $bus_booking_states->master_bus_bookings }}</span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </a>
                                                ...
                                                <div class="row">
                                                    ...
                                                    @else
                                                        ...
                                                        @if(Auth::user('merchant')->can('view_reports_charts'))
                                                            ...
                                                            @if(!empty($segment->renewable_subscription_earning_online))
                                                                <div class="col-xl-5 col-md-5 col-sm-6 info-panel">
                                                                    <a href="#">
                                                                        <div class="card card-shadow"
                                                                             style="margin-bottom:0.243rem">
                                                                            <div class="card-block bg-white p-20">
                                                                                ...
                                                                                <span class="ml-10 font-weight-400">@lang("$string_file.renewable_subscriptions") @lang("$string_file.online") @lang("$string_file.earning")</span>
                                                                                <div class="content-text text-center mb-0">
                                                                                    <span class="font-size-18 font-weight-100">{{ $segment->renewable_subscription_earning_online }}</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </a>
                                                            ...
                                                            @if(!empty($segment->renewable_subscription_earning_wallet))
                                                                <div class="col-xl-4 col-md-4 col-sm-6 info-panel">
                                                                    <a href="#">
                                                                        <div class="card card-shadow"
                                                                             style="margin-bottom:0.243rem">
                                                                            <div class="card-block bg-white p-20">
                                                                                ...
                                                                                <span class="ml-10 font-weight-400">@lang("$string_file.renewable_subscriptions") @lang("$string_file.wallet") @lang("$string_file.earning")</span>
                                                                                <div class="content-text text-center mb-0">
                                                                                    <span class="font-size-18 font-weight-100">{{ $segment->renewable_subscription_earning_wallet }}</span>
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                    </a>
