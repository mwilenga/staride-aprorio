...
<div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">>
    <div class="page-content vertical-align-middle animation-slide-top animation-duration-1">
        ...
        <div class="brand" style="margin-bottom: 22px;">
            ...
            <h4 class="brand-text">Welcome {{$user->full_name}}</h4>
        </div>

        <form method="POST" action="{{ route('business-segment.user.delete') }}" style="margin:0px 0px;">
            @csrf
            ...
            {{ Form::hidden('user_id', Auth::user('business-segment')->id, ["class" => "form-control", "id" => 'user_id',"readonly"=>true]) }}
    ...
    <!-- <form method="POST" action="{{ route('user.logout') }}" style="margin:0px 0px;">
        @csrf -->
        <a href="{{route('business-segment.user.logout')}}">
