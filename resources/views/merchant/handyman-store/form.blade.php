...
{{--                @if(isset($data['handyman_store'  ]['id']))--}}
{{--                    @php $id = $data['handyman_store']['id']; $disabled = true @endphp--}}
{{--                @endif--}}
{{--                @if($id == NULL)--}}
...
{{--                    {!! Form::hidden('id',old('id',isset($data['handyman_store']['id']) ? $data['handyman_store']['id'] : NULL),['id'=>'id']) !!}--}}
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('full_name',old('full_name',isset($data['handyman_store']['full_name']) ? $data['handyman_store']['full_name'] : NULL),['id'=>'','class'=>'form-control','required'=>true]) !!}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('email',old('email',isset($data['handyman_store']['email']) ? $data['handyman_store']['email'] : NULL),['id'=>'','class'=>'form-control','required'=>true]) !!}
                                @if ($errors->has('email'))
                                ...
                                <select class="form-control select2" name="country_id"
                                    ...
                                    @foreach($data['countries']  as $country)
                                        <option data-currency-code="{{ $country->isoCode }}"
                                                ...
                                                @if(isset($data['handyman_store']['country_id']) && $data['handyman_store']['country_id'] == $country->id) selected @endif>
...
{{--                                {!! Form::select('country_id',$data['countries'],old('country_id',isset($data['handyman_store']['country_id']) ? $data['handyman_store']['country_id'] : NULL),['id'=>'','class'=>'form-control','required'=>true]) !!}--}}
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('phone_number',old('phone_number',isset($data['handyman_store']['phone_number']) ? $data['handyman_store']['phone_number'] : NULL),['id'=>'','class'=>'form-control','required'=>true]) !!}
                        ...
                        <div class="col-md-4" id="areaList">
                            <div class="form-group">
                                ...
                                {!! Form::text('landmark',old('landmark',isset($data['handyman_store']['landmark']) ? $data['handyman_store']['landmark'] : NULL),['id'=>'','class'=>'form-control','required'=>true]) !!}
...
{{--                                        <span class="text-danger">*</span>--}}
{{--                                    </label>--}}
{{--                                    {!! Form::select('grocery_configuration_instant_slot',$grocery_instant_slot,old('grocery_configuration_instant_slot',isset($data['handyman_store']['grocery_configuration_instant_slot']) ? $data['handyman_store']['grocery_configuration_instant_slot'] : NULL),['id'=>'grocery_configuration_instant_slot','class'=>'form-control','required'=>true]) !!}--}}
...
{{--                            </div>--}}
{{--                        @endif--}}
                        @if(in_array(6,$arr_merchant_service_type) && isset($data['handyman_store']))
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label for="emailAddress5">
                                    ...
                                    {!! Form::select('self_pickup',$data['self_pickup'],old('self_pickup',isset($data['handyman_store']['self_pickup']) ? $data['handyman_store']['self_pickup'] : NULL),['id'=>'self_pickup','class'=>'form-control','required'=>true]) !!}
                                </div>
                            </div>
                        @endif
                        @if(in_array(7,$arr_merchant_service_type))
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    {!! Form::select('dine_in',$data['dine_in'],old('dine_in',isset($data['handyman_store']['dine_in']) ? $data['handyman_store']['dine_in'] : NULL),['id'=>'dine_in','class'=>'form-control','required'=>true]) !!}
                                </div>
                            </div>
                        @endif
                        <div class="col-md-4 corporate_inr">
                            <div class="form-group">
                                <label for="location3">
                                    ...
                                    @if(!empty($data['handyman_store']['business_logo']))
                                        @php $required = false; @endphp
                                        <a href="{{get_image($data['handyman_store']['business_logo'],'handyman_store_logo')}}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @if(!empty($data['handyman_store']['login_background_image']))
                                    <a href="{{get_image($data['handyman_store']['login_background_image'],'handyman_store_login_background_image')}}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                @if(!empty($data['handyman_store']['business_profile_image']))
                                    <a href="{{get_image($data['handyman_store']['business_profile_image'],'handyman_store_profile_image')}}"
                                       target="_blank">@lang("$string_file.view")</a>
                                @endif
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::select('status',$data['arr_status'],old('status',isset($data['handyman_store']['status']) ? $data['handyman_store']['status'] : NULL),['id'=>'','class'=>'form-control','required'=>true]) !!}
...
{{--                                    <span class="text-danger">*</span>--}}
{{--                                </label>--}}
{{--                                {!! Form::select('order_request_receiver',$data['request_receiver'],old('order_request_receiver',isset($data['handyman_store']['order_request_receiver']) ? $data['handyman_store']['order_request_receiver'] : NULL),['id'=>'','class'=>'form-control','required'=>true]) !!}--}}
...
{{--                        </div>--}}
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <span class="input-group-text" id="commission_method_symbol">
                                            @if(isset($data ['handyman_store']['commission_method']) && $data ['handyman_store']['commission_method'] == 1)
                                                {{ $data['handyman_store']->CountryArea->Country->isoCode }}
                                            @elseif(isset($data ['handyman_store']['commission_method']) && $data ['handyman_store']['commission_method'] == 2)
                                                %
                                            @endif
                                        </span>
                                    </div>
                                    {!! Form::number("commission",old("commission",isset($data ['handyman_store']['commission']) ? $data ['handyman_store']['commission'] : NULL),["step"=>"0.01", "min"=>"0","class"=>"form-control", "id"=>"commission","placeholder"=>'',"required"=>true]) !!}
                                </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('latitude',old('latitude',isset($data['handyman_store']['latitude']) ? $data['handyman_store']['latitude'] : NULL),['id'=>'lat','class'=>'form-control','required'=>true,'readonly' => true]) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('longitude',old('longitude',isset($data['handyman_store']['longitude']) ? $data['handyman_store']['longitude'] : NULL),['id'=>'lng','class'=>'form-control','required'=>true,'readonly' => true]) !!}
                            </div>
                        </div>
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('address',old('address',isset($data['handyman_store']['address']) ? $data['handyman_store']['address'] : NULL),['id'=>'location','class'=>'form-control','required'=>true,'readonly' => true]) !!}
                    ...
                    @php $arr_account_info = !empty($data['handyman_store']['bank_details']) ? json_decode($data['handyman_store']['bank_details'],true) : [];  @endphp
                    <div class="row">
                        <div class="col-md-4 ">
                            <div class="form-group">
                                <label for="minimum_amount">
...
{{--                    </div>--}}
    ...
    <input type="hidden" id="currency" value="{{ isset($data ['handyman_store']['commission_method']) ? $data ['handyman_store']->CountryArea->Country->isoCode : "" }}"/>
...
@section('js')
    <script type="text/javascript">
        ...
        function initialize() {
            ...
            var lat = "{{ isset($data['handyman_store']['latitude']) ? $data['handyman_store']['latitude'] : $default_lat }}";
            var long = "{{ isset($data['handyman_store']['longitude']) ? $data['handyman_store']['longitude'] : $default_long }}";
