                                    ...
                                    @if(!empty($all_vehicle_details))
                                         @foreach($all_vehicle_details as $vehicle_details)
                                             <div class="col-md-12 mt-20 mb-10">
                                                <h5>@lang("$string_file.vehicle_details")
                                                @if(!empty($vehicle_details->pivot->is_detached) && $vehicle_details->pivot->is_detached == 1)
                                                    <span class="badge badge-danger ml-2" style="font-size: 0.8rem;">
                                                        @lang("$string_file.detach")
                                                    </span>
                                                @elseif($can_detach_vehicles && !empty($vehicle_details->pivot->is_detached) && $vehicle_details->pivot->is_detached == 2 && $vehicle_details->pivot->vehicle_active_status != 1)
                                                    <a href="{{ route('vehicles.detach', ['vehicle_id' => $vehicle_details->id, 'driver_id' => $driver->id]) }}"
                                                       class="btn btn-warning btn-sm ml-2">
                                                        @lang("$string_file.detach_vehicle")
                                                    </a>
                                                @endif
                                                </h5>
                                                <hr>
                                                    ...
                                                    <div class="col-lg-4">
                                                        <div class="row">
                                                            ...
                                                            @if($driver_add_vehicle_seatOrside_image_enable == 1)
                                                                <div class="col-md-6 col-sm-7">
                                                                    <h6>@lang("$string_file.vehicle")  @lang("$string_file.seat_image") </h6>
                                                                    <div class="" style="width: 6.5rem;">
                                                                        <div class=" bg-light">
                                                                            @php $vehicle_seat_image = get_image($vehicle_details->vehicle_seat_image,'vehicle_document'); @endphp
                                                                            <a href="{{ $vehicle_seat_image }}" target="_blank"><img src="{{ $vehicle_seat_image }}" style="width:100%;height:80px;"></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-6 col-sm-7">
                                                                    <h6>@lang("$string_file.vehicle")  @lang("$string_file.side_view_image") </h6>
                                                                    <div class="" style="width: 6.5rem;">
                                                                        <div class=" bg-light">
                                                                            @php $vehicle_side_view_image = get_image($vehicle_details->vehicle_side_view_image,'vehicle_document'); @endphp
                                                                            <a href="{{ $vehicle_side_view_image }}" target="_blank"><img src="{{ $vehicle_side_view_image }}" style="width:100%;height:80px;"></a>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            @endif
