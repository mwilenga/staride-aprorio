            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    <div class="panel-actions">
                        ...
                        <a href="{{route('merchant.driver.expiredocuments.export')}}" data-toggle="tooltip">
                            <button type="button" class="btn btn-icon btn-primary mr-1 mt-2 float-right">
                                <i title="@lang("$string_file.export_excel")" class="fa fa-download"></i>
                            </button>
                        </a>
                    </div>
