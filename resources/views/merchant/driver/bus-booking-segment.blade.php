            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">
                        ...
                        @lang("$string_file.driver_name") : {{$driver->first_name .' '.$driver->last_name}} ->  @lang("$string_file.bus_booking") @lang("$string_file.configuration")
                    </h3>
                </header>
                ...
                <div class="panel-body container-fluid">
                    {!! Form::open(['name'=>'','class'=>'steps-validation wizard-notification','id'=>'driver-handyman-segment','files'=>true,'url'=>route('merchant.driver.bus-booking.segment.save',$id)]) !!}
