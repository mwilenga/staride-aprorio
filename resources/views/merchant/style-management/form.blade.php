    ...
    <div class="page">
        <div class="page-content">
            ...
            <div class="panel panel-bordered">
                ...
                @php $id = isset($data['style_management']['id']) ? $data['style_management']['id'] : NULL; @endphp
                <div class="panel-body container-fluid">
                    {!! Form::open(['name'=>'style-management','id'=>'style-management','files'=>true,'url'=>$data['save_url'],'method'=>'POST'] ) !!}
                    <div class="row">
                        <div class="col-md-4">
                            <div class="form-group">
                                ...
                                {!! Form::text('style_name',old('style_name',isset( $data['style_management']['id']) ? $data['style_management']->Name($data['style_management']['merchant_id']) : NULL),['id'=>'style_name','class'=>'form-control','required'=>true]) !!}
