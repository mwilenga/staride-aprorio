                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-default" id="dataTable" >
                                            ...
                                            <tr>
                                                ...
                                                <th width="30%"
                                                    class="address"> <b>{{ $booking->travel_time_min }} @lang("$string_file.min")</b>
                                                </th>
                                            </tr>
                                            @if($booking->onride_waiting_time)
                                                <tr>
                                                    <th width="20%"><b>@lang("$string_file.onride_waiting_time")</b></th>
                                                    <th width="30%"
                                                        class="address"> <b>{{ $booking->onride_waiting_time }} @lang("$string_file.min")</b>
                                                    </th>
                                                </tr>
                                            @endif
                                            @if(!empty($booking->BookingDetail) && $booking->BookingDetail->wait_time)
                                                <tr>
                                                    <th width="20%"><b>@lang("$string_file.before_start_wait_time")</b></th>
                                                    <th width="30%"
                                                        class="address"> <b>{{ $booking->BookingDetail->wait_time }} @lang("$string_file.min")</b>
                                                    </th>
                                                </tr>
                                            @endif
                                            </tfoot>
