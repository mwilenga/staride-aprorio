            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <div class="panel-actions">
                        ...
                        @endif
                        <a href="{{ route('merchant.bus_booking.active.auto-assign') }}" @if($auto_assign_count == 0) style="pointer-events: none;" @endif>
                            <button type="button"
                                    class="btn btn-icon btn-info float-right" style="margin:10px">
                                @lang("$string_file.auto_booking_assign")
                                <span class="badge badge-pill">{{ $auto_assign_count }}</span>
                            </button>
                        </a>
                    </div>
                    <h3 class="panel-title"><i class="wb-flag" aria-hidden="true"></i>
                        @lang("$string_file.active_bus_bookings")
                    </h3>
                </header>
