            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">
                        ...
                        @lang("$string_file.order_earning_statistics_of") <span class="blue-500"> {{ is_demo_data($driver->first_name.' '.$driver->last_name,$driver->Merchant) }} ({{ is_demo_data($driver->phoneNumber,$driver->Merchant) }}) </span>
                    </h3>
                        ...
                        <div class="col-xl-3 col-md-3 info-panel">
                            <div class="card card-shadow">
                                <div class="card-block bg-grey-100 p-20">
                                    ...
                                    <div class="content-text text-center mb-0">
                                        <span class="font-size-20 font-weight-100">{{isset($business_summary['income']['order_amount']) ? $currency.$business_summary['income']['order_amount'] : 0}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-md-3 info-panel">
                            <div class="card card-shadow">
                                <div class="card-block bg-grey-100 p-20">
                                    ...
                                    <div class="content-text text-center mb-0">
                                        <span class="font-size-20 font-weight-100">{{isset($business_summary['income']['driver_earning']) ? $currency.$business_summary['income']['driver_earning'] : 0}}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                                        ...
                                        @if(!empty($arr_orders))
                                            ...
                                            @foreach($arr_orders as $order)
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @lang("$string_file.at") {{date('H:i',strtotime($order->created_at))}},
