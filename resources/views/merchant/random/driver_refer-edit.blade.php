...
<script src="http://ajax.googleapis.com/ajax/libs/jquery/1.9.1/jquery.min.js"></script>
    <script>
        ...
        $(window).load(function() {
            var div_value2 = {{$refer->offer_type}}
            if(div_value2 == 2){
                $("#show_hide").show();
            }
        });
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <h3 class="content-header-title mb-0 d-inline-block"><i class="fas fa-user-plus"></i> @lang('admin.driver_refer_system')</h3>
                                        <div class="btn-group float-md-right">
                                            <a href="{{ route('merchant.refer.driver_view') }}">
                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <form method="POST" enctype="multipart/form-data"
                                                  ...
                                                  enctype="multipart/form-data" action="{{ route('merchant.refer.driver.update',$refer->id) }}">
                                                @csrf
                                                <fieldset>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control required" onchange="return show_div(this);" name="offer_type" id="offer_type"
                                                                        required>
                                                                    <option value="1"
                                                                            @if($refer->offer_type == 1) selected @endif>@lang('admin.commission_compensation')</option>
                                                                    <option value="2"
                                                                            @if($refer->offer_type == 2) selected @endif>@lang("common.fixed") @lang("common.amount")</option>
                                                                </select>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6"  id="show_hide">
                                                            <div class="form-group">
                                                                <label for="location">
                                                                    @lang("common.fixed") @lang("common.amount")<span class="text-danger">*</span>
                                                                </label>
                                                                <input type="text" value="{{$refer->fixed_value}}" class="form-control"
                                                                       id="fixed_amount"
                                                                       name="fixed_amount"
                                                                       placeholder="@lang("common.fixed") @lang("common.amount")">
