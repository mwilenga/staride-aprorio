                                    ...
                                    <div class="card-content collapse show">
                                        <div class="card-body">
                                            <form method="POST" enctype="multipart/form-data"
                                                  ...
                                                  action="{{ route('merchant.refer.driver.store') }}">
                                                @csrf
                                                <fieldset>
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                ...
                                                                <select class="form-control required" onchange="return show_div(this);" name="offer_type"
                                                                    ...
                                                                    <option value="1">@lang('admin.commission_compensation')</option>
                                                                    <option value="2">@lang("common.fixed") @lang("common.amount")</option>
                                                                </select>
