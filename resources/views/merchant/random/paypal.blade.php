            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    <h3 class="panel-title"><i class="wb-earning" aria-hidden="true"></i>
                        @lang("$string_file.paypal")   @lang("common.configuration") </h3>
                </header>
                <div class="panel-body container-fluid">
                    <section id="validation">
                        <form method="POST" class="steps-validation wizard-notification"
                              enctype="multipart/form-data"
                              action="{{ route('merchant.gateway.paypal.store') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="firstName3">
                                            @lang("$string_file.paypal") @lang("common.public") @lang("common.key") <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control"
                                               id="public _key" name="public_key"
                                               placeholder=" @lang("common.public") @lang("common.key") "
                                               value="@if(!empty($paypal_config)) {{ $paypal_config->api_public_key}} @endif"
                                               required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="firstName3">
                                           @lang("$string_file.paypal") @lang("common.secret") @lang("common.key") <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" class="form-control"
                                               id="secret_key"
                                               name="secret_key"
                                               placeholder="@lang("common.secret") @lang("common.key") "
                                               value="@if(!empty($paypal_config)) {{ $paypal_config->api_secret_key }} @endif"
                                               required>
