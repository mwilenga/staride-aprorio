                    ...
                    <div class="card-header py-3">
                        ...
                        <div class="btn-group float-md-right">
                            <div class="heading-elements">
                                ...
                                <a href="{{route('merchant.refer.driver')}}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            @switch($refer->offer_type)
                                                @case(1)
                                                @lang('admin.commission_compensation')
                                                @break
                                                @case(2)
                                        ...
                                        <td>
                                            @if(Auth::user('merchant')->can('edit_refer'))
                                                <a href="{{ route('merchant.refer.driver.edit',$refer->id) }}"
                                                ...
                                                @if($refer->status == 1)
                                                    <a href="{{ route('merchant.refer.driver.active-deactive',['id'=>$refer->id,'status'=>2]) }}"
                                                ...
                                                @else
                                                    <a href="{{ route('merchant.refer.driver.active-deactive',['id'=>$refer->id,'status'=>1]) }}"
