            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title">
                        ...
                        @lang("$string_file.taxi_company_cashout_request")
                    </h3>
                </header>
                            ...
                            <tr>
                                ...
                                <td>
                                    <span class="long_text">
                                        {{$cashout_request->TaxiCompany->name}} <br>
                                        {{$cashout_request->TaxiCompany->phone}} <br>
                                        {{$cashout_request->TaxiCompany->email}} 
                                    </span>
                                </td>
                                <td>{{ $cashout_request->TaxiCompany->Country->isoCode.' '.$cashout_request->amount  }}</td>
                                <td>
                                ...
                                <td>
                                    @if($cashout_request->cashout_status != 2)
                                        <a href="{{ route('merchant.taxi-company.cashout_status',$cashout_request->id) }}"
