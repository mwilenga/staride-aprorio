            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <section id="validation">
                        <form method="POST" class="steps-validation wizard-notification" id="taxicompany-form"
                              name="taxicompany-form"
                              enctype="multipart/form-data" action="{{ route('merchant.taxi-company.save',$id) }}">
                            @csrf
                            {!!  Form::hidden('id',$id,array("id" => "taxi_company_id")) !!}
                            <div class="row">
                                <div class="col-md-4">
                                        ...
                                        <select class="form-control" id="country" name="country">
                                            ...
                                            @foreach($countries as $country)
                                                <option value="{{$country->id}}"
                                                        @if(!empty($company))@if($company->country_id == $country->id) selected @endif @endif>{{$country->CountryName}}</option>
                                            @endforeach
                                        </select>
                                ...
                                @if($config->Configuration->enable_sub_partner == 1)
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="location3">@lang("$string_file.segment")</label>
                                        <div class="mb-2">
                                            <input type="checkbox" id="select_all_segments"> <label for="select_all_segments">Select All</label>
                                        </div>
                                        <select class="form-control select2" name="segment_ids[]" id="segment" multiple>
                                            {{--<option value="">@lang("$string_file.select")</option>--}}
                                            @foreach($segments as $segment)
                                                <option value="{{ $segment->id }}"
                                                    @if(!empty($selected_segment) && in_array($segment->id, $selected_segment)) selected @endif>
                                                    {{ $segment->name }}
                                                </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="segment_id" id="segment">
                                            ...
                                            @foreach($segments as $segment)
                                                <option value="{{$segment->id}}"
                                                        @if(!empty($company) && $company->segment_id == $segment->id) selected @endif>{{$segment->name}}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('segment_id'))
                                            <label class="text-danger">{{ $errors->first('segment_id') }}</label>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="contact_person"
                                               name="contact_person"
                                               value="{{isset($company->contact_person) ? $company->contact_person : NULL}}"
                                               placeholder="" required>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="address"
                                               name="address"
                                               value="{{isset($company->address) ? $company->address : NULL}}"
                                               placeholder="" required>
                                ...
                                <div class="col-md-4 corporate_inr">
                                    <div class="form-group">
                                        ...
                                        <input style="height: 0%;" class="form-control" type="file" name="company_logo"
                                               id="company_logo">
                                ...
                                <div class="col-md-4 corporate_inr">
                                    <div class="form-group">
                                        <label for="location3"> @lang("$string_file.company_background_image")
                                            <span class="text-danger">*</span>
                                        </label>
                                        <input style="height: 0%;" class="form-control" type="file" name="company_background_image"
                                               id="company_background_image">
                                        @if ($errors->has('company_background_image'))
                                            <label class="text-danger">{{ $errors->first('company_background_image') }}</label>
                                        @endif
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bank_name"
                                               name="bank_name"
                                               value="{{old('bank_name',isset($company->bank_name) ? $company->bank_name : NULL)}}"
                                               placeholder="">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control"
                                               ...
                                               value="{{old('account_holder_name',isset($company->account_holder_name) ? $company->account_holder_name : NULL)}}"
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control required"
                                               id="account_number"
                                               value="{{isset($company->account_number) ? $company->account_number : NULL}}"
                                               name="account_number"
                                        >
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select type="text" class="form-control"
                                            ...
                                            @foreach($account_types as $account_type)
                                                <option value="{{$account_type->id}}" value="{{$account_type->id}}"
                                                        @if(!empty($company)) @if($company->account_type_id == $account_type->id) selected @endif @endif > @if($account_type->LangAccountTypeSingle){{$account_type->LangAccountTypeSingle->name}} @else {{$account_type->LangAccountTypeAny->name}} @endif</option>
                                            @endforeach
                                        </select>
...
<script>
    $(document).ready(function () {
        ...
        $('#select_all_segments').on('change', function () {
            if ($(this).is(':checked')) {
                // Select all
                let allValues = $('#segment option').map(function () {
                    return $(this).val();
                }).get();
                $('#segment').val(allValues).trigger('change');
            } else {
                // Deselect all
