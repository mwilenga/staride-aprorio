        ...
        <div class="page-content">
            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    ...
                    <div class="rounded p-4 mb-2 bg-white">
                        <div class="row mb-3">
                           <div class="col-md-12">
                                 <input type="checkbox" id="select-all" class="form-check-input">
                                      <label for="select-all" class="form-check-label font-weight-bold">Select All</label>
                           </div>
                    </div>
                                                ...
                                                <div class="col-md-9">
                                                    <div class="row">
                                                        @foreach($segment['arr_services'] as $key_inner=>$service)
                                                            ...
                                                            <div class="col-md-4">
                                                                <div class="form-group">
                                                                    <input name="segment_service_type[{{$key}}][]" value="{!! $service_type_id !!}" id="{!! $service_type_id !!}" class="form-group mr-20 mt-5 ml-20 area_segment segment-checkbox" type="checkbox" {{$checked}}>{!! $service['locale_service_name'] !!}
                                                                </div>
                                                            </div>
                                                        @endforeach
                                                    </div>
...
<script>
    ...
    $(document).ready(function () {
        ...
        $('#select-all').on('change', function () {
            ...
            $('.segment-checkbox').prop('checked', isChecked);
        });
        ...
        $('.segment-checkbox').on('change', function () {
            ...
            if ($('.segment-checkbox:checked').length === $('.segment-checkbox').length) {
