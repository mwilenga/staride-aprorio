            ...
            <div class="panel panel-bordered">
                <header class="panel-heading">
                    ...
                    <h3 class="panel-title"><i class="icon wb-plus" aria-hidden="true"></i>
                         @lang("$string_file.product_availability_time_slabs")@if(!empty($id))
                        @endif
                    </h3>
                </header>
                            ...
                            <div class="row">
                                <div class="col-md-12 table-responsive">
                                    <table class="table table-bordered" id="timeSlotsTable">
                                        ...
                                        <tbody>
                                        @php
                                            $oldNames  = old('time_slab_name', []);
                                            $oldStart  = old('start_time', []);
                                            $oldEnd    = old('end_time', []);
                                            $oldAllDay = old('available_all_day', []);
                                            $old_priority = old('priority', []);
                                            $old_custom_price = old('custom_price', []);
                                            $rowCount  = max(count($oldNames), 1);
                                        @endphp
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input type="checkbox"
                                                           ...
                                                           value="1"
                                                            {{ old('available_all_day.'.$i) ? 'checked' : '' }}
                                                ...
                                                <td>
                                                    <input type="number" 
                                                           ...
                                                           style="display: {{ old('is_custom.'.$i) ? 'block' : 'none' }};">
                                                </td>
