                ...
                <div class="panel-body container-fluid">
                    ...
                    <table id="customDataTable" class="display nowrap table table-hover table-stripedw-full"
                        ...
                        @foreach($arr_orders as $order)
                            ...
                            @endphp
                            @if((!empty($order->Merchant->Configuration->accept_order_before_driver_assign_enable) && $order->Merchant->Configuration->accept_order_before_driver_assign_enable == 1 && $order->order_status == 9) || !in_array(9,$order_history))
                            @php
				        ...
				        @endif
                                ...
                                <td>
                                    @if(!empty($order->Merchant->Configuration->accept_order_before_driver_assign_enable) && $order->Merchant->Configuration->accept_order_before_driver_assign_enable == 1 && $order->order_status == 9)
                                        @if($order->BusinessSegment->order_request_receiver == 1)
                                                ...
                                                @endif
                                            @elseif($order->BusinessSegment->order_request_receiver == 2)
                                                @php
...
@endif
                ...
                <div class="modal fade text-left" id="auto_assign" tabindex="-1" role="dialog" aria-labelledby="myModalLabel33" aria-hidden="true">
