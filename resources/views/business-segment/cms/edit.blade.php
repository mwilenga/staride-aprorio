            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <form method="POST" class="steps-validation wizard-notification" id="cms-form" name="cms-form"
                          ...
                          action="{{ route('business-segment.cms.update',$cmspage->id) }}">
                        {{method_field('PUT')}}
                            ...
                            <div class="row">
                                <div class="col-md-12" id="description_div" @if($cmspage->content_type == 2) style="display: none;" @endif>
                                    <div class="form-group">
                                        ...
                                        <textarea id="summernote" class="form-control summernote" name="description" rows="5" placeholder="@lang("$string_file.description")" data-plugin="summernote">@if($cmspage->content_type == 1) @if($cmspage->LanguageSingle){{ $cmspage->LanguageSingle->description }} @else {{$cmspage->LanguageAny->description}} @endif @endif</textarea>
