                ...
                <form method="post" enctype="multipart/form-data" action="{{ route('business-segment.cashout.request') }}">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            @if(isset($business_segment->Merchant->BookingConfiguration->is_business_segment_cashout_pg) && $business_segment->Merchant->BookingConfiguration->is_business_segment_cashout_pg == 1)
                                {!! $cashout_view !!}
                            @endif
                        </div>
                    </div>
