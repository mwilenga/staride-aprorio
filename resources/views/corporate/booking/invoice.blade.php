                        ...
                        <section class="card shadow h-100">
                            <div id="section-to-print" class="card">
                                ...
                                <div class="card-header"> @lang("$string_file.ride_id") <strong>#{{ $booking->merchant_booking_id }}</strong>
                                    ...
                                    {{--                               class="btn btn-sm btn-warning float-right mr-2"><i class="fas fa-mail-bulk"></i>@lang("$string_file.send_invoice")</a>--}}
                                </div>
                                @if(Auth::user()->tax)
                                                ...
                                                <tr>
                                                    <td width="50%">
                                                        <table align="center" width="100%" border="0">
                                                            ...
                                                            <tr><td align="center"><img class="profile_img"
                                                                                        ...
                                                                                        src="@if ($booking->Driver->profile_image) {{ get_image($booking->Driver->profile_image,'driver',$booking->Merchant->id) }} @else {{ get_image(null, 'driver',$booking->Merchant->id) }} @endif"
                                                    ...
                                                    <td width="50%">
                                                        <table width="100%" border="0">
                                                            ...
                                                            <tr>
                                                                <td align="center"><img
                                                                            src="{{ get_image($booking->VehicleType->vehicleTypeImage,'vehicle',$booking->Merchant->id) }}"
                                                                            width="100" height="100"></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="4px;"></td>
