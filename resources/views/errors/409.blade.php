...
<div class="page vertical-align text-center" data-animsition-in="fade-in" data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
        <header>
            <h1 class="animation-slide-top font-weight-500 font-size-50">S3 FILE SYSTEM ERROR</h1>
            <h4 class="animation-slide-top">S3 bucket configuration is pending. Please contact to development team.</h4>
        </header>
    </div>
</div>
