            ...
            <div class="panel panel-bordered">
                ...
                <div class="panel-body container-fluid">
                    <style>
                        ...
                        /*Label + immediate following element (the star) inline */
                        .panel-body .col-md-4 .form-group .form-control-label + * {
                            display: inline-block !important;
                            margin-left: 6px !important;
                            white-space: nowrap !important;
                        }

                        /* Make the label content (including the star) stay on one line */
                        #start-div .form-group .form-control-label {
                            display: inline-flex !important;        /* label and its inline content in one row */
                            align-items: center !important;
                            gap: 6px !important;                    /* space between label text and star */
                            white-space: nowrap !important;
                            margin-bottom: 4px !important;          /* keep label compact */
                            width: auto !important;                 /* avoid full-width labels that can cause wrapping */
                        }

                        /* Ensure the star itself doesn't drop to next line */
                        #start-div .form-group .form-control-label .text-danger {
                            display: inline-block !important;
                        ...
                        /* If the star isn’t wrapped by .text-danger (as in the snippet),
                           target any inline element inside the label after the text */
                        #start-div .form-group .form-control-label > span {
                            display: inline-block !important;
                            margin-left: 6px !important;
                            white-space: nowrap !important;
                            line-height: 1 !important;
                        ...
                        /* Keep the input group below as a separate block */
                        #start-div .form-group .input-group {
                            margin-top: 6px !important;
                        }


                        #end-div .form-group .form-control-label {
                            display: inline-flex !important;        /* label and its inline content in one row */
                            align-items: center !important;
                            gap: 6px !important;                    /* space between label text and star */
                            white-space: nowrap !important;
                        ...
                        /* Ensure the star itself doesn't drop to next line */
                        #end-div .form-group .form-control-label .text-danger {
                            display: inline-block !important;
                            line-height: 1 !important;
                            margin: 0 !important;
                            white-space: nowrap !important;
                        ...
                        /* If the star isn’t wrapped by .text-danger (as in the snippet),
                           target any inline element inside the label after the text */
                        #end-div .form-group .form-control-label > span {
                            display: inline-block !important;
                            margin-left: 6px !important;
                            white-space: nowrap !important;
                            line-height: 1 !important;
                        ...
                        /* Keep the input group below as a separate block */
                        #end-div .form-group .input-group {
                            margin-top: 6px !important;
                        }

                        /* Keep the label text and star on one line, star on the right of the text */
                        label.form-control-label[for="ride_radius_driver"] {
                            display: inline-flex !important;     /* make label and its children align in a row */
                            align-items: center !important;
                            gap: 6px !important;                 /* space between text and star */
                            white-space: nowrap !important;      /* prevent wrapping to next line */
                            margin-bottom: 4px !important;       /* keep compact */
                            width: auto !important;              /* avoid full-width label */
                        }

                        /* Ensure the star itself stays inline and doesn’t wrap */
                        label.form-control-label[for="ride_radius_driver"] > .text-danger,
                        label.form-control-label[for="ride_radius_driver"] > span {
                            display: inline-block !important;
                            line-height: 1 !important;
                            margin: 0 !important;
                            white-space: nowrap !important;
                        ...
                        /* Driver label: keep text and star on one line */
                        label[for="driver_id"] {
                            display: inline-flex !important;      /* align label contents horizontally */
                            align-items: center !important;
                            gap: 6px !important;                  /* spacing between text and star */
                            white-space: nowrap !important;       /* prevent star wrapping below */
                            margin-bottom: 4px !important;        /* compact spacing */
                            width: auto !important;               /* avoid full-width label */
                        }

                        /* Ensure the star itself stays inline */
                        label[for="driver_id"] > .text-danger,
                        label[for="driver_id"] > span {
                            display: inline-block !important;
                            margin: 0 !important;
                            line-height: 1 !important;
                            white-space: nowrap !important;
                        ...
                        /* Driver availability label: keep text and star inline */
                        label.form-control-label[for="driver_marker"] {
                            display: inline-flex !important;      /* align label contents horizontally */
                            align-items: center !important;
                            gap: 6px !important;                  /* space between text and star */
                        ...
                        /* Ensure the star itself stays inline */
                        label.form-control-label[for="driver_marker"] > .text-danger,
                        label.form-control-label[for="driver_marker"] > span {
                            display: inline-block !important;
                            margin: 0 !important;
                            line-height: 1 !important;
                            white-space: nowrap !important;
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-section">
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                <select class="form-control form-control" id="manual_user_type"
                                                    ...
                                                    @if(Auth::user('merchant')->can('view_corporate') && $baseConfig->corporate_admin == 1)
                                                        <option value="3">@lang("$string_file.corporate_user")</option>
                                                    @endif
                                                </select>
                                            </div>
                                        ...
                                        <div class="col-md-4 custom-hidden" id="full_details_div">
                            ...
                            <div class="col-md-12">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="col-md-12 form-group" style="margin-top: 10%">
...
@endsection
@section('js')
    <script src="https://maps.googleapis.com/maps/api/js?key=<?= get_merchant_google_key(NULL,'admin_backend');?>&libraries=geometry"></script>
    ...
    <script>
        ...
        $(document).ready(function () {
            $('#pickup_location').select2({
                ...
                ajax: {
                    delay: 250,
                    method: 'POST',
                    url: "{{ route('taxicompany.search-places') }}",
                    headers: {
        ...
        $('#pickup_location').on('select2:select', function (e) {
            ...
            $.ajax({
                url: "{{ route('taxicompany.reverse-geocode-google-location') }}",  // Replace with your actual route
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': "{{ csrf_token() }}"
                },
                ...
                success: function (response) {
                    ...
                    setAreaAfterPickup("{{ csrf_token() }}", pickupLat, pickupLng, merchant_id, segment);
        ...
        $('#drop_location').on('select2:select', function (e) {
            ...
            $.ajax({
                url: "{{ route('taxicompany.reverse-geocode-google-location') }}",
                method: 'POST',
                headers: {
                    'X-CSRF-TOKEN': "{{ csrf_token() }}"
                },
                ...
                success: function (response) {
                    ...
                    var merchant_id = {{$config->merchant_id}};
                    var segment = $('#segment').val();
                    setAreaAfterPickup("{{ csrf_token() }}", lat, lng, merchant_id, segment);
        ...
        function setAreaAfterPickup(token, pickupLat, pickupLng, merchant_id, segment){
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': token
                },
        ...
        function getDistanceData(pickup_location, drop_location, waypts,  callback){
            $.ajax({
                ...
                method: 'POST',
                url: "{{route('taxicompany.google-direction-data')}}",
                data: {from: pickup_location ,to: drop_location, waypts: waypts, request_from: "taxicompany"},
                success:function (data) {
        ...
        function getDistanceMatrixData(coord_string, dest, callback){
            ...
            $.ajax({
                ...
                method: 'POST',
                url: "{{route('taxicompany.google-distance-matrix-data')}}",
                data: {coord_string: coord_string ,dest: dest, request_from: "taxicompany"},
                success:function (data) {
                    if(data.status == "SUCCESS"){
                         callback(null, data);
                    }else{
