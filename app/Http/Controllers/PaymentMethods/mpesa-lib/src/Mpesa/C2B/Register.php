...
class Register
{
     ...
     * @var string
     */
    protected $endpoint = 'mpesa-lib/c2b/v1/registerurl';
    ...
    public function submit($params = [],$appName='default'){
        ...
        $shortCode = $this->engine->config->get('mpesa-lib.c2b.short_code');
        $confirmationURL   = $this->engine->config->get('mpesa-lib.c2b.confirmation_url');
        $onTimeout   = $this->engine->config->get('mpesa-lib.c2b.on_timeout');
        $validationURL   = $this->engine->config->get('mpesa-lib.c2b.validation_url');
