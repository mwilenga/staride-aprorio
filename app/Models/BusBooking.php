...
//    protected $hidden = array('pivot', 'LanguageSingle', 'LanguageAny');
    ...
    protected static function boot()
    {
        ...
        static::creating(function ($model) {
            $model->merchant_bus_booking_id = $model->NewGuid();
            return $model;
        });
    }
    ...
    public function NewGuid() {
        ...
        $booking = BusBooking::where('merchant_bus_booking_id', $guid)->first();
        if(!empty($booking)){
            $guid = $this->NewGuid();
        }
        // return $guid;
        return substr($guid,0,10);
    }
...
//
    ...
    public function BusBookingDetail()
    {
        return $this->hasMany(BusBookingDetail::class);
    }
    ...
    public function BusBookingRating()
    {
        return $this->hasOne(BusBookingRating::class);
    }

    public function BusBookingPackageDetail()
    {
        return $this->hasMany(BusBookingPackageDetail::class);
    }
